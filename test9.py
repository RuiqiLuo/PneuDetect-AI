...
try:
    ...
    dataloaders = {
        'train': DataLoader(
            ...
            batch_sampler=balanced_batch_sampler,  # Use batch_sampler instead of sampler
...
scheduler = lr_scheduler.ReduceLROnPlateau(optimizer, mode='max', factor=0.2, patience=3, threshold=0.001)
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val':
                ...
                if history['val_auc'] and len(history['val_auc']) == epoch + 1:
